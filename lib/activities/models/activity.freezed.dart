...
mixin _$Activity {
 ...
 int get id; String get description;@JsonKey(name: 'created_at') DateTime get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Activity&&(identical(other.id, id) || other.id == id)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
@override
String toString() {
  return 'Activity(id: $id, description: $description, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String description,@JsonKey(name: 'created_at') DateTime createdAt
});
...
class _Activity implements Activity {
  const _Activity({required this.id, required this.description, @JsonKey(name: 'created_at') required this.createdAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Activity&&(identical(other.id, id) || other.id == id)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
